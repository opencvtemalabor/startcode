...
namespace Tests
{
    ...
    public class TestDrawing
    {
        ...
        public void DrawingInit()
        {
            ...
            Assert.Equal(toVec3b(color), currentColor);
            Assert.Equal(imageSize, image.Size());
        }
        ...
        public void TestDrawingSimpleDrawing()
        {
            ...
            Assert.True(IsLinePresent(image, a, b, pen1));
            Assert.True(IsLinePresent(image, b, c, pen1));
            Assert.True(IsLinePresent(image, d, e, pen2));
            Assert.True(IsLinePresent(image, e, f, pen2));
            Assert.True(IsLinePresent(image, g, h, background));
        }
